<header x-data="{ open: false }" :class="{'headeropen': open}" id="header" class="z-10 text-center justify-center" style="touch-action: none; top: 0px;">	  
                    <div class="flex justify-end flex-shrink-0 px-6 py-4">
			<div class="flex mr-auto">
               <a href="../settings"><img class="h-8 w-8" style="filter:brightness(0.1)" src="https://postogon.com/assets/logo.svg" alt="postogon logo"></a>
